...
if (first && !window.location.pathname.includes('en')) {
  ...
  first = false;
  jQuery("#changeLangActive").append('<img alt = "China" width="20%" src = "http://purecatamphetamine.github.io/country-flag-icons/3x2/CN.svg" /><span> 中文</span><img style="width: 10%; margin-left: 10%;" src="/static/images/changeLanIcon.svg"/>');
}
else {
  first = false;
  jQuery("#en").css({ "background-color": "#3f4042" })
  jQuery("#zh").css({ "background-color": "#292a2d" })
  jQuery("#changeLangActive").append('<img alt = "US" width="20%" src = "http://purecatamphetamine.github.io/country-flag-icons/3x2/US.svg" /><span style="color: #fff;"> English</span><img style = "width: 10%; margin-left: 8%;" src = "/static/images/changeLanIcon.svg" />');
}
